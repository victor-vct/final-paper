...
\caption{Raspberry Pi 3. Fonte: \citecustom{raspimage}}
\label{Rotulo}
\end{figure}
...
\caption{Arduino Uno. Fonte: \citecustom{arduinounoimage}}
\label{Rotulo}
\end{figure}
...
\caption{Módulo NEO u-blox 6 GPS. Fonte: \citecustom{neo6mimage}}
\label{Rotulo}
\end{figure}

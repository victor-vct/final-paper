...
O NEO U-BLOX 6 é um módulo que permite obter a geolocalização por meio de \textit{GPS (Global Position System)}. A tecnologia GPS funciona através de ondas de rádio que são transmitidas por satélites, onde o aparelho receptor localiza o sinal de pelo quatro deles. Com o sinal recebido, é feito cálculos para obter a localização no globo. 

Realizando uma comunicação com protocolo UART (Universal Asynchronous Receiver/Transmitter), é possível obter as informações do módulo. 
